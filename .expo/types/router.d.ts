...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/autumn` | `/dream` | `/editorial` | `/goMode` | `/goModeAutumn` | `/goModeDream` | `/goModeEditorial` | `/goModeHamlet` | `/goModeHonk` | `/goModeLost` | `/goModeOnward` | `/goModeShowman` | `/hamlet` | `/honk` | `/immortal` | `/lost` | `/modal` | `/onward` | `/questions1` | `/questions2` | `/questions3` | `/showman` | `/stayMode`;
  // prettier-ignore
