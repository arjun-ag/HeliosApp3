...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/autumn` | `/dream` | `/editorial` | `/goMode` | `/goModeAutumn` | `/goModeDream` | `/goModeEditorial` | `/goModeHamlet` | `/goModeHonk` | `/goModeLost` | `/goModeOnward` | `/goModeShowman` | `/hamlet` | `/honk` | `/immortal` | `/lost` | `/modal` | `/onward` | `/questions1` | `/questions2` | `/questions3` | `/showman` | `/stayMode`;
